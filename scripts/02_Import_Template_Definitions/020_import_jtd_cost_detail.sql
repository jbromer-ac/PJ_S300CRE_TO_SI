    ...
    FROM (
        ...
        FROM (
            ...
            SELECT
                ...
                ISNULL(JT.NEW_JOB_ID, '') + ' | Acct Date: ' + ISNULL(CONVERT(VARCHAR(10), JCT.Accounting_Date, 120), '') + ' | Applicationz of Origin: ' +
            ...
            GROUP BY
                JCT.Data_Folder_Id,
                JCT.Accounting_Date,
                ISNULL(JT.NEW_JOB_ID, '') + ' | Acct Date: ' + ISNULL(CONVERT(VARCHAR(10), JCT.Accounting_Date, 120), '') + ' | Applicationz of Origin: ' + ISNULL(JCT.Application_of_Origin, '') + ' | Batch: ' + ISNULL(JCT.Batch, ''),
