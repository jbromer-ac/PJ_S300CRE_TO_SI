...
public class MappingExporter
{
    ...
    [
        ...
        new SheetDef(
            ...
            HeaderRow: 3,
            LegacyColCount: 4,
            Headers: ["Data Folder ID", "Vendor", "Vendor Description", "Status", "Vendor"],
            Sql: """
                SELECT DATA_FOLDER_ID, LEGACY_VENDOR_ID, LEGACY_VENDOR_NAME, LEGACY_VENDOR_STATUS, NEW_VENDOR_ID
