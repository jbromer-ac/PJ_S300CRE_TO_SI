...
-- Add columns introduced after initial deployment (safe to run on existing tables)
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'MAP' AND TABLE_NAME = 'T_TRANS_BASEACCT' AND COLUMN_NAME = 'FIN_STMT')
    ALTER TABLE MAP.T_TRANS_BASEACCT ADD FIN_STMT VARCHAR(2) NULL;
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'MAP' AND TABLE_NAME = 'T_TRANS_BASEACCT' AND COLUMN_NAME = 'BALANCE')
    ALTER TABLE MAP.T_TRANS_BASEACCT ADD BALANCE VARCHAR(2) NULL;
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'MAP' AND TABLE_NAME = 'T_TRANS_BASEACCT' AND COLUMN_NAME = 'CLOSEABLE')
    ALTER TABLE MAP.T_TRANS_BASEACCT ADD CLOSEABLE VARCHAR(1) NULL;
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'MAP' AND TABLE_NAME = 'T_TRANS_BASEACCT' AND COLUMN_NAME = 'ACCT_TYPE')
    ALTER TABLE MAP.T_TRANS_BASEACCT ADD ACCT_TYPE VARCHAR(75) NULL;
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'MAP' AND TABLE_NAME = 'T_TRANS_BASEACCT' AND COLUMN_NAME = 'REQUIRED')
    ALTER TABLE MAP.T_TRANS_BASEACCT ADD REQUIRED NVARCHAR(1) NULL;
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'MAP' AND TABLE_NAME = 'T_TRANS_BASEACCT' AND COLUMN_NAME = 'CMO')
    ALTER TABLE MAP.T_TRANS_BASEACCT ADD CMO VARCHAR(50) NULL;
IF NOT EXISTS (SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'MAP' AND TABLE_NAME = 'T_TRANS_BASEACCT' AND COLUMN_NAME = 'CATEGORY')
    ALTER TABLE MAP.T_TRANS_BASEACCT ADD CATEGORY NVARCHAR(75) NULL;
GO